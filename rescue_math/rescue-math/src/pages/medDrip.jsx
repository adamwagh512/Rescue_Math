...
const handleDripSetChange = (event) => {
...
const [weightedDose, setWeightedDose] = useState('')
const handleWeightedDoseChange = (event) => {
    setWeightedDose(event.target.value)
}

const [addedFluid, setAddedFluid] = useState('')
const handleAddedFluidChange = (event) => {
    setAddedFluid(event.target.value)
}
