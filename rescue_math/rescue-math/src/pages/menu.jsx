      ...
      <div className="bg-black h-max">
        ...
        <div className={michroma.className}>
          <div className="flex flex-col justify-center items-center">
            ...
            <a href="/weightMedBolus"><button className="bg-blue-800 rounded-lg p-5 mt-10 w-[75vw]">
              Weight-Based Med Bolus
            </button></a>
            <a href="/weightFluid"><button className="bg-blue-800 rounded-lg p-5 mt-10 w-[75vw]">
